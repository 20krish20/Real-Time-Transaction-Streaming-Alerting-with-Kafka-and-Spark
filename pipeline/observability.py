...
class PipelineMetrics:
    ...
    # Bronze
    bronze_records_written: Counter = field(
    ...
    bronze_dlq_routed: Counter = field(
        default_factory=lambda: Counter(
    ...
    bronze_batch_duration_seconds: Histogram = field(
    ...
    # Gold
    gold_reconciled_pairs: Counter = field(
        default_factory=lambda: Counter(
    ...
    gold_anomalies_detected: Counter = field(
        default_factory=lambda: Counter(
    ...
    gold_batch_duration_seconds: Histogram = field(
        default_factory=lambda: Histogram(
    ...
    gold_watermark_lag_seconds: Gauge = field(
    ...
    # Snowflake writer
    snowflake_rows_written: Counter = field(
        default_factory=lambda: Counter(
    ...
    snowflake_write_errors: Counter = field(
        default_factory=lambda: Counter(
    ...
    kafka_consumer_lag: Gauge = field(
        default_factory=lambda: Gauge(
...
def poll_kafka_consumer_lag(bootstrap_servers: str, group_ids: list[str]) -> None:
    ...
    try:
        ...
        for group_id in group_ids:
            ...
            for _group, future in result.items():
